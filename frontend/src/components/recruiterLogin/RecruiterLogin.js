      ...
      <div className="container" style={{ paddingTop: "70px" }}>
        <Row className="mb-3">
              ...
              <div className="login-input-form" style={{ marginLeft: "0em" }}>
                <Form className="form" noValidate onSubmit={handleSubmit}>
                  ...
                  <Form.Group className="mb-3" controlId="formPassword">
                    ...
                    />
                    {validated && (invalidEmail || invalidPassword) && (
                      <div
                        style={{
                          color: "#dc3545",
                          fontSize: ".875em",
                  ...
                  {false && (
                    <Form.Group
                      ...
                      controlId="basicCheckbox"
                    >
                      <a className="forgotPw" href="temp.com">
                        Forgot Password?
                      </a>
                    </Form.Group>
                  )}
                  <div
                    className="noAccount d-flex justify-content-center mb-4"
                    style={{
                      fontSize: "15px",
                      color: "#777",
                      marginRight: "165px",
          ...
          <Col className="d-none d-lg-inline">
            <div className="recruiter-loginPic"></div>
          </Col>
        </Row>
      </div>
    </div>
