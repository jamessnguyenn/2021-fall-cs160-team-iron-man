...
You will need to request a review by any of the developers which will then either approve the pull request or request you to fix some issues.  If your code needs to be fixed, you can directly commit and push to the branch and it will show up in the pull request.
