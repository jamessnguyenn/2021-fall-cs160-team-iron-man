...
/*
    Note:
    Run FrontendTest class for testing instead
*/
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        Frontend tester = new Frontend();

        /*
        //Recruiter tests
        tester.invalidRecruiterTest(driver, "test@yahoo.com", "password");
        tester.invalidRecruiterTest(driver, "recruiter@email.com", "wrongPassword");
        tester.recruiterFrontendTest(driver, "recruiter@email.com", "password");
        tester.recruiterLogoutTest(driver,"recruiter@email.com", "password");

        //Jobseeker tests
        tester.invalidJobseekerTest(driver, "test@yahoo.com", "password");
        tester.invalidJobseekerTest(driver, "seeker@email.com", "wrongPassword");
        tester.jobseekerFrontendTest(driver, "seeker@email.com", "password");
        tester.jobseekerLogoutTest(driver, "seeker@email.com", "password");

        //2.x & 3.x tests
        tester.jobSeekerSignUpTest(driver);
        tester.recruiterSignUpTest(driver);
         */
    ...
    public int invalidRecruiterTest(WebDriver driver, String username, String password) {
    ...
    public int invalidJobseekerTest(WebDriver driver, String username, String password) {
    ...
    public int recruiterFrontendTest(WebDriver driver, String username, String password) {
    ...
    public int jobseekerFrontendTest(WebDriver driver, String username, String password) {
    ...
    public int jobseekerLogoutTest(WebDriver driver, String username, String password) {
    ...
    public int recruiterLogoutTest(WebDriver driver, String username, String password) {
    ...
    public int jobSeekerSignUpTest(WebDriver driver) {
    ...
    public int recruiterSignUpTest(WebDriver driver) {
    ...
    public static int invalidRecruiterTest(WebDriver driver, String username, String password) {
        System.out.println("Invalid Recruiter Test (" + username + ", " + password + ")");
        driver.get("http://localhost:3000/");
        WebElement element = driver.findElement(By.xpath("/html/body/div/div/div/div/div[1]/div[2]/div/div[2]/button"));
        element.click();
